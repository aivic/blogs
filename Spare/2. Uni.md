...
Let us learn to build color palette for first three classes. To learn about what and where to use these classes, refer the matplotlib colormap guide mentioned above.
...
### 3. Diverging
To create diverging color palettes, Seaborn provides `sns.diverging_palette` method which accepts anchor hues for negative and positive extents of the map, saturation, and many other parameters as shown with an example:
...
![Diverging](https://i.imgur.com/rUOBXNJ.png)

## Conclusion
In this guide, you have learned creating your own color palettes and choosing among various built-in color palettes available in Seaborn.
...
3. [Visualizing the regression variants]() 
4. [Controlling figure aesthetics]()
